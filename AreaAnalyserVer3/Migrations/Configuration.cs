...
//            #region crime
//            resourceName = "AreaAnalyserVer3.CrimeToEniscrone.csv";
...
//                {
//                    var offences = listOfOffences.Where(x => x.StationAddress.Contains(s.Address)).ToList();
//                    if (offences != null)
//                    {
//                        offences.ForEach(i => i.StationId = s.StationId);
//                        offences.ForEach(off => context.Offence.Add(off));
